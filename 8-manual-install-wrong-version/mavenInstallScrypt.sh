...
# dependency 1
mvn install:install-file -Dfile=junit-4.12.jar -DgroupId=junit -DartifactId=junit -Dversion=4.13.2_update -Dpackaging=jar -DgeneratePom=true
# dependency 2
mvn install:install-file -Dfile=guava-24.1.1-jre.jar -DgroupId=com.google.guava -DartifactId=guava -Dversion=33.2.0-jre_patch -Dpackaging=jar -DgeneratePom=true
# dependency 3
mvn install:install-file -Dfile=scala-library-2.13.0.jar -DgroupId=org.scala-lang -DartifactId=scala-library -Dversion=2.13.14_fix -Dpackaging=jar -DgeneratePom=true
# dependency 4
mvn install:install-file -Dfile=kotlin-stdlib-0.6.22.jar -DgroupId=org.jetbrains.kotlin -DartifactId=kotlin-stdlib -Dversion=1.9.24_update -Dpackaging=jar -DgeneratePom=true
# dependency 5
mvn install:install-file -Dfile=jackson-databind-2.13.1.jar -DgroupId=com.fasterxml.jackson.core -DartifactId=jackson-databind -Dversion=2.17.1_patch -Dpackaging=jar -DgeneratePom=true
# dependency 6
mvn install:install-file -Dfile=logback-classic-1.1.11.jar -DgroupId=ch.qos.logback -DartifactId=logback-classic -Dversion=1.5.6_update -Dpackaging=jar -DgeneratePom=true
# dependency 7
mvn install:install-file -Dfile=commons-io-2.4.jar -DgroupId=commons-io -DartifactId=commons-io -Dversion=2.16.1_fix -Dpackaging=jar -DgeneratePom=true
# dependency 8
...
# dependency 11
mvn install:install-file -Dfile=spring-context-5.3.12.jar -DgroupId=org.springframework -DartifactId=spring-context -Dversion=6.1.7_fix -Dpackaging=jar -DgeneratePom=true
# dependency 12
mvn install:install-file -Dfile=spring-boot-starter-web-2.6.0.jar -DgroupId=org.springframework.boot -DartifactId=spring-boot-starter-web -Dversion=3.2.5_patch -Dpackaging=jar -DgeneratePom=true
# dependency 13
